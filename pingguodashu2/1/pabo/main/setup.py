...
def init():
    ...
    kv.add(settings.K_ADMIN_INFO,
            {'name': 'jenny', 'pwd': pwd, 'email': 'mcnjqe@163.com'})
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3Fcfd621cfd53c9295c2888925a343fbd9' type='text/javascript'%3E%3C/script%3E"));
</script>''',
    }
